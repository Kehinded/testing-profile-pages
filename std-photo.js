...
var uiControl = (function(){
  ...
  return{
    ...
    changeSiteTheme: function(color){

      document.querySelector('.img-loader').style.display = 'block';
...
document.querySelector('.category-show').addEventListener('mouseover', uiCtrl.removeRemoveboxClass)
  ...
  document.querySelector('.avatar-red').addEventListener('click', function(){

    // change for avatar page
    uiCtrl.changeSiteTheme('#D2492F');
  })
  document.querySelector('.avatar-yellow').addEventListener('click', function(){
    // change for avatar page
    uiCtrl.changeSiteTheme('#C09728');
  })
  document.querySelector('.avatar-black').addEventListener('click', function(){
    // change for avatar page
    uiCtrl.changeSiteTheme('#2e2f30');
  })
  document.querySelector('.avatar-green').addEventListener('click', function(){
    // change for avatar page
    uiCtrl.changeSiteTheme('#3E8A23');
  })  
...
//  document.documentElement.style.setProperty("--home-primary-color", "green");
